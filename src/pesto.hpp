...
#define WHITE_PAWN      (2*pPAWN   + WHITE)
#define BLACK_PAWN      (2*pPAWN   + BLACK)
#define WHITE_KNIGHT    (2*pKNIGHT + WHITE)
#define BLACK_KNIGHT    (2*pKNIGHT + BLACK)
#define WHITE_BISHOP    (2*pBISHOP + WHITE)
#define BLACK_BISHOP    (2*pBISHOP + BLACK)
#define WHITE_ROOK      (2*pROOK   + WHITE)
#define BLACK_ROOK      (2*pROOK   + BLACK)
#define WHITE_QUEEN     (2*pQUEEN  + WHITE)
#define BLACK_QUEEN     (2*pQUEEN  + BLACK)
#define WHITE_KING      (2*pKING   + WHITE)
#define BLACK_KING      (2*pKING   + BLACK)
#define EMPTY           (BLACK_KING  +  1)
#define PIECE_WITH_SIDE(p, s) ((2 * p) + s)
#define PCOLOR(p) ((p)&1)
